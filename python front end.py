...
#now for buttons
bt1 = tk.Button(row1, text = '1', font = 'Arial 18', width = 5, height = 2)
bt1.pack(side = tk.LEFT, padx = 5,pady = 5)
bt1.bind("<Button-1>", click)
#for 2nd
bt2 = tk.Button(row1, text = "2", font = "Arial 18", width = 5, height = 2)
bt2.pack(side = tk.LEFT , padx = 5, pady = 5)
bt2.bind("<Button-1>", click)
#for 3rd
bt3 = tk.Button(row1, text = "3", font = "Arial 18", width = 5, height = 2)
...
#for 4th
bt4 = tk.Button(row2, text ='4', font = 'Arial 18', width = 5, height = 2)
bt4.pack(side = tk.LEFT, padx = 5, pady = 5)
bt4.bind("<Button-1>",click)

#for 5th

bt5 = tk.Button(row2, text = '5', font = 'Arial 18', width = 5, height = 2)
bt5.pack(side = tk.LEFT, padx = 5, pady = 5)
bt5.bind("<Button-1>",click)

#for 6th
bt6 = tk.Button(row2, text = '6', font = 'Arial 18', width = 5, height = 2)
...
bt7 = tk.Button(row3, text = '7', font = 'Arial 18', width = 5, height = 2)
bt7.pack(side = tk.LEFT, padx = 5, pady = 5)
bt7.bind("<Button-1>",click)
#for 8th
bt8 = tk.Button(row3, text = '8', font = 'Arial 18', width = 5, height = 2)
bt8.pack(side = tk.LEFT, padx = 5, pady = 5)
bt8.bind("<Button-1>",click)
#for 9th
bt9 = tk.Button(row3, text = '9', font = 'Arial 18', width = 5, height = 2)
...
btC = tk.Button(row4, text = 'C' ,font = 'Arial 18', width = 5, height = 2)
btC.pack(side = tk.LEFT, padx = 5, pady = 5)
btC.bind("<Button-1>",click)

bt0 = tk.Button(row4, text = '0', font = 'Arial 18', width = 5, height = 2)
bt0.pack(side = tk.LEFT, padx = 5, pady = 5)
bt0.bind("<Button-1>",click)

btEQ = tk.Button(row4, text = '=', font = 'Arial 18', width = 5, height = 2)
btEQ.pack(side = tk.LEFT, padx = 5, pady = 5)
btEQ.bind("<Button-1>",click)

btnADD = tk.Button(row4, text = '+', font = 'Arial 18', width = 5, height = 2)
btnADD.pack(side = tk.LEFT, padx = 5, pady = 5)
btnADD.bind("<Button-1>",click)
#for subtraction
btnSUB = tk.Button(row4, text = '-', font = 'Arial 18', width = 5, height = 2)
